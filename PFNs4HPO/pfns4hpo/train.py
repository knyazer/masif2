...
from . import positional_encodings, utils
from .bar_distribution import BarDistribution, get_custom_bar_dist
from .priors import prior
from .transformer import TransformerModel
from .utils import get_cosine_schedule_with_warmup, get_openai_lr, init_dist
...
def train(
    ...
    **model_extra_args,
    ...
    single_eval_pos_gen = (
        single_eval_pos_gen if callable(single_eval_pos_gen) else lambda: single_eval_pos_gen
    )
                ...
                try:
                    ...
                    with autocast(enabled=scaler is not None):
                        ...
                        if len(targets.shape) == len(output.shape):
                            # this implies the prior uses a trailing 1 dimension
